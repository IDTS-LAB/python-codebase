...
from sqlalchemy import Date, String, Boolean, Index
...
class UserModel(
    ...
    auth_provider: Mapped[str] = mapped_column(String(50), default=AuthProvider.LOCAL, nullable=False)
    external_id: Mapped[str | None] = mapped_column(String(255), nullable=True)
    
    # Status
    status: Mapped[str] = mapped_column(String(50), default=UserStatus.PENDING_VERIFICATION, nullable=False)
